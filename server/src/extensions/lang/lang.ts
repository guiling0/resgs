sgs.GeneralSetting('wars.caocao', {
    title: '魏武帝',
    id: 'WEI001',
    designer: 'KayaK',
    cv: '马洋',
...
sgs.GeneralSetting('wars.simayi', {
    title: '狼顾之鬼',
    id: 'WEI002',
    designer: 'KayaK',
    cv: '龚韶华',
    ...
    skills: {
        ...
        ['wars.simayi.guicai']: {
            ...
            desc2:
                '当判定结果确定前，你可打出对应的实体牌是你的一张牌且与此牌牌名相同的牌▶系统将此牌作为判定牌，将原判定牌置入弃牌堆。\n' +
...
sgs.GeneralSetting('wars.xiahoudun', {
    title: '独眼的罗刹',
    id: 'WEI003',
    designer: 'KayaK',
    cv: '冷泉夜月',
...
sgs.GeneralSetting('wars.zhangliao', {
    title: '前将军',
    id: 'WEI004',
    designer: 'KayaK',
    cv: '万小鳖',
...
sgs.GeneralSetting('wars.guojia', {
    title: '早终的先知',
    id: 'WEI006',
    designer: 'KayaK',
    cv: '花少关',
...
sgs.GeneralSetting('wars.zhenji', {
    title: '薄幸的美人',
    id: 'WEI007',
    designer: 'KayaK',
    cv: '林簌',
    ...
    skills: {
        ['wars.zhenji.luoshen']: {
            ...
            desc2:
                '准备阶段开始时，你可判定▶若结果为黑色，你可重复此流程。你获得所有的黑色判定牌。\n' +
...
sgs.GeneralSetting('wars.xiahouyuan', {
    title: '疾行的猎豹',
    id: 'WEI008',
    designer: 'KayaK',
    cv: '未知',
...
sgs.GeneralSetting('wars.zhanghe', {
    title: '料敌机先',
    id: 'WEI009',
    designer: 'KayaK',
    cv: '彭尧',
...
sgs.GeneralSetting('wars.xuhuang', {
    title: '周亚夫之风',
    id: 'WEI010',
    designer: 'KayaK',
    cv: '彭尧',
...
sgs.GeneralSetting('wars.caoren', {
    title: '大将军',
    id: 'WEI011',
    designer: 'KayaK',
    cv: '徐少杰',
...
sgs.GeneralSetting('wars.dianwei', {
    title: '古之恶来',
    id: 'WEI012',
    designer: 'KayaK',
    cv: '彭尧',
...
sgs.GeneralSetting('wars.yuejin', {
    title: '奋强突固',
    id: 'WEI016',
    designer: '淬毒',
    cv: '冷泉夜月',
...
sgs.GeneralSetting('wars.liubei', {
    title: '乱世的枭雄',
    id: 'SHU001',
    designer: 'KayaK',
    cv: '彭博',
...
sgs.GeneralSetting('wars.guanyu', {
    title: '美髯公',
    id: 'SHU002',
    designer: 'KayaK',
    cv: '未知',
...
sgs.GeneralSetting('wars.zhangfei', {
    title: '万夫不当',
    id: 'SHU003',
    designer: 'KayaK',
    cv: '未知',
...
sgs.GeneralSetting('wars.zhugeliang', {
    title: '迟暮的丞相',
    id: 'SHU004',
    designer: 'KayaK',
    cv: '未知',
...
sgs.GeneralSetting('wars.zhaoyun', {
    title: '虎威将军',
    id: 'SHU005',
    designer: 'KayaK&Loun老萌',
    cv: '未知',
    painter: 'KayaK',
    script: '归零',
    rs: '刘禅',
...
sgs.GeneralSetting('wars.machao', {
    title: '一骑当千',
    id: 'SHU006',
    designer: 'KayaK',
    cv: '彭博',
    painter: 'KayaK&木美人&张帅',
    script: '归零',
    rs: '马岱',
    death_audio: '请将我葬在西凉……',
    skills: {
...
sgs.GeneralSetting('wars.huangyueying', {
    title: '归隐的杰女',
    id: 'SHU007',
    designer: 'KayaK',
    cv: '林簌',
...
sgs.GeneralSetting('wars.huangzhong', {
    title: '老当益壮',
    id: 'SHU008',
    designer: 'KayaK',
    cv: '未知',
...
sgs.GeneralSetting('wars.v2025.huangzhong', {
    title: '老当益壮',
    id: 'SHU008',
    designer: 'KayaK',
    cv: '未知',
...
sgs.GeneralSetting('wars.weiyan', {
    title: '嗜血的独狼',
    id: 'SHU009',
    designer: 'KayaK',
    cv: '拜跃',
...
sgs.GeneralSetting('wars.pangtong', {
    title: '凤雏',
    id: 'SHU010',
    designer: 'KayaK',
    cv: '彭尧',
...
sgs.GeneralSetting('wars.wolong', {
    title: '卧龙',
    id: 'SHU011',
    designer: 'KayaK',
    cv: '彭尧',
...
sgs.GeneralSetting('wars.liushan', {
    title: '无为的真命主',
    id: 'SHU013',
    designer: 'KayaK',
    cv: '彭尧',
...
sgs.GeneralSetting('wars.menghuo', {
    title: '南蛮王',
    id: 'SHU014',
    designer: 'KayaK',
    cv: '彭尧',
...
sgs.GeneralSetting('wars.zhurong', {
    title: '野性的女王',
    id: 'SHU015',
    designer: 'KayaK',
    cv: '未知',
...
sgs.GeneralSetting('wars.ganfuren', {
    title: '昭烈皇后',
    id: 'SHU016',
    designer: '淬毒',
    cv: '水原',
...
sgs.GeneralSetting('wars.sunquan', {
    title: '年轻的贤君',
    id: 'WU001',
    designer: 'KayaK',
    cv: '薛倞',
...
sgs.GeneralSetting('wars.ganning', {
    title: '锦帆游侠',
    id: 'WU002',
    designer: 'KayaK',
    cv: '未知',
...
sgs.GeneralSetting('wars.lvmeng', {
    title: '士别三日',
    id: 'WU003',
    designer: 'Loun老萌',
    cv: '绯川陵彦',
...
sgs.GeneralSetting('wars.huanggai', {
    title: '轻身为国',
    id: 'WU004',
    designer: 'KayaK',
    cv: '徐少杰',
...
sgs.GeneralSetting('wars.zhouyu', {
    title: '大都督',
    id: 'WU005',
    designer: 'KayaK',
    cv: '刘以嘉',
...
sgs.GeneralSetting('wars.daqiao', {
    title: '矜持之花',
    id: 'WU006',
    designer: 'KayaK',
    cv: '林簌',
...
sgs.GeneralSetting('wars.v2025.luxun', {
    version: '2025移动版修订',
    title: '擎天之柱',
    id: 'WU007',
    designer: 'KayaK&韩旭',
...
sgs.GeneralSetting('wars.sunshangxiang', {
    title: '弓腰姬',
    id: 'WU008',
    designer: 'KayaK',
    cv: '未知',
...
sgs.GeneralSetting('wars.sunjian', {
    title: '武烈帝',
    id: 'WU009',
    designer: 'KayaK',
    cv: '彭博',
...
sgs.GeneralSetting('wars.xiaoqiao', {
    title: '矫情之花',
    id: 'WU011',
    designer: 'KayaK',
    cv: '未知',
    ...
    skills: {
        ['wars.xiaoqiao.tianxiang']: {
            ...
            desc2:
                '当你受到伤害时❸，你可弃置一张红桃手牌并选择一名其他角色▶你防止此伤害，选择：1.令来源对其造成1点普通伤害▷其摸X张牌（X=min{其已损失的体力值,5}）；2.令其失去1点体力▷若牌堆/弃牌堆里有你以此法弃置的牌，其获得牌堆/弃牌堆里的你以此法弃置的牌\n' +
...
sgs.GeneralSetting('wars.taishici', {
    title: '笃烈之士',
    id: 'WU012',
    designer: 'KayaK',
    cv: '彭尧',
...
sgs.GeneralSetting('wars.zhoutai', {
    title: '历战之躯',
    id: 'WU013',
    designer: 'KayaK',
    cv: '李杨',
...
sgs.GeneralSetting('wars.zhangzhaozhanghong', {
    title: '经天纬地',
    id: 'WU015',
    designer: 'KayaK',
    cv: '彭尧',
...
sgs.GeneralSetting('wars.dingfeng', {
    title: '清侧重臣',
    id: 'WU016',
    designer: '淬毒',
    cv: '冷泉夜月',
...
sgs.GeneralSetting('wars.huatuo', {
    title: '神医',
    id: 'QUN001',
    designer: '韩旭',
    cv: '彭博',
...
sgs.GeneralSetting('wars.diaochan', {
    title: '绝世的舞姬',
    id: 'QUN003',
    designer: 'KayaK',
    cv: '林簌',
...
sgs.GeneralSetting('wars.yuanshao', {
    title: '高贵的名门',
    id: 'QUN004',
    designer: 'KayaK',
    cv: '彭尧',
...
sgs.GeneralSetting('wars.yanliangwenchou', {
    title: '虎狼兄弟',
    id: 'QUN005',
    designer: 'KayaK',
    cv: '彭尧',
...
sgs.GeneralSetting('wars.pangde', {
    title: '人马一体',
    id: 'QUN008',
    designer: '韩旭',
    cv: '刘北辰',
...
sgs.GeneralSetting('wars.zhangjiao', {
    title: '天公将军',
    id: 'QUN010',
    designer: 'KayaK',
    cv: '未知',
    ...
    skills: {
        ...
        ['wars.zhangjiao.guidao']: {
            ...
            desc2:
                '当判定结果确定前，你可打出对应的实体牌是你的一张黑色牌且与此牌牌名相同的牌。系统将此牌作为判定牌。你获得原判定牌。\n' +
...
sgs.GeneralSetting('wars.caiwenji', {
    title: '异乡的孤女',
    id: 'QUN012',
    designer: 'KayaK',
    cv: '未知',
...
sgs.GeneralSetting('wars.mateng', {
    title: '驰骋西陲',
    id: 'QUN013',
    designer: '淬毒',
    cv: '龚韶华',
...
sgs.GeneralSetting('wars.kongrong', {
    title: '凛然重义',
    id: 'QUN014',
    designer: '淬毒',
    cv: '未知',
...
sgs.GeneralSetting('wars.jiling', {
    title: '仲家的主将',
    id: 'QUN015',
    designer: '淬毒',
    cv: '龚韶华',
...
sgs.GeneralSetting('wars.v2025.jiling', {
    version: '2025移动版修订',
    title: '仲家的主将',
    id: 'QUN015',
    designer: '淬毒',
...
sgs.GeneralSetting('wars.tianfeng', {
    title: '河北瑰杰',
    id: 'QUN016',
    designer: '淬毒',
    cv: '龚韶华',
...
sgs.GeneralSetting('wars.v2025.tianfeng', {
    version: '2025移动版修订',
    title: '河北瑰杰',
    id: 'QUN016',
    designer: '淬毒',
...
sgs.GeneralSetting('wars.panfeng', {
    title: '联军上将',
    id: 'QUN017',
    designer: '傅翊钧',
    cv: '龚韶华',
...
sgs.GeneralSetting('wars.v2025.panfeng', {
    version: '2025移动版修订',
    title: '联军上将',
    id: 'QUN017',
    designer: '傅翊钧&Loun老萌',
...
sgs.GeneralSetting('wars.zoushi', {
    title: '惑心之魅',
    id: 'QUN018',
    designer: '淬毒',
    cv: '水原',
...
sgs.GeneralSetting('wars.simayi_jin', {
    title: '冢虎',
    id: 'JIN001',
    designer: '山巅隐士',
    cv: '马洋',
...
sgs.GeneralSetting('wars.zhangchunhua_jin', {
    title: '冷血皇后',
    id: 'JIN002',
    designer: '山巅隐士',
    cv: '诺语兰',
...
sgs.GeneralSetting('wars.simashi', {
    title: '睚眦侧目',
    id: 'JIN003',
    designer: '山巅隐士',
    cv: '李洋',
...
sgs.GeneralSetting('wars.simazhao', {
    title: '嘲风开天',
    id: 'JIN004',
    designer: '山巅隐士',
    cv: '人到中年的李皮',
...
sgs.GeneralSetting('wars.simazhou', {
    title: '温恭的狻猊',
    id: 'JIN005',
    designer: '山巅隐士',
    cv: '云中亭曲',
...
sgs.GeneralSetting('wars.simaliang', {
    title: '冲粹的蒲牢',
    id: 'JIN006',
    designer: '山巅隐士',
    cv: 'LIU巴斯',
...
sgs.GeneralSetting('wars.simalun', {
    title: '螭吻裂冠',
    id: 'JIN011',
    designer: '山巅隐士',
    cv: '冷泉夜月',
...
sgs.GeneralSetting('wars.shibao', {
    title: '经国之才',
    id: 'JIN016',
    designer: '山巅隐士',
    cv: '翔宇_hxy',
...
sgs.GeneralSetting('wars.yanghuiyu', {
    title: '克明礼教',
    id: 'JIN017',
    designer: '山巅隐士',
    cv: '楼倾司',
...
sgs.GeneralSetting('wars.wangyuanji', {
    title: '垂心万物',
    id: 'JIN018',
    designer: '山巅隐士',
    cv: '苏子芜',
...
sgs.GeneralSetting('wars.weiguan', {
    title: '忠允清識',
    id: 'JIN020',
    designer: '山巅隐士',
    cv: '-安志-',
...
sgs.GeneralSetting('wars.jiachong', {
    title: '悖逆篡弑',
    id: 'JIN021',
    designer: '山巅隐士',
    cv: '飛流',
...
sgs.GeneralSetting('wars.guohuai_jin', {
    title: '嫉贤妒能',
    id: 'JIN027',
    designer: '山巅隐士',
    cv: '张溪敉',
...
sgs.GeneralSetting('wars.wangjun', {
    title: '顺流长驱',
    id: 'JIN036',
    designer: '山巅隐士',
    cv: '王教授就是王宇航',
...
sgs.GeneralSetting('wars.malong', {
    title: '困局诡阵',
    id: 'JIN037',
    designer: '山巅隐士',
    cv: '王教授就是王宇航',

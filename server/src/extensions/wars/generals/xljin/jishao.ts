...
export const jishao = sgs.General({
    name: 'xl.jishao',
    kingdom: 'jin',
    hp: 2,
    gender: Gender.Male,
...
export const xiangan = sgs.Skill({
    ...
    sgs.StateEffect({
        ...
        [StateEffectType.Regard_Kingdom](player) {
            if (this.isOwner(player)) {
                ...
                if (uncle) return uncle._kingdom;
            }
        },
    })
);

jishao.addSkill(bugu);
jishao.addSkill(xiangan);

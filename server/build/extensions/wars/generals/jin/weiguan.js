...
exports.jiantong = exports.chengxi = exports.weiguan = void 0;
...
exports.chengxi = sgs.Skill({
    name: 'wars.weiguan.chengxi',
});
exports.chengxi.addEffect(sgs.TriggerEffect({
    auto_log: 1,
                    ...
                    selectors: {
                        player: room.createChoosePlayer({
                            ...
                            filter(item, selected) {
                                return item.canUseCard(yiyidailao.vdata, undefined, self.name);
                            },
                        }),
                    },
                    options: {
    ...
    async effect(room, data, context) {
        ...
        const drop = room.getPeriodHistory(use).find((v) => {
            ...
            return (move &&
                ...
                move.has_filter((d, c) => d.reason === 6 /* MoveCardReason.DisCard */ &&
                    c.type !== 1 /* CardType.Basic */));
        });
        if (drop) {
...
exports.jiantong = sgs.Skill({
    name: 'wars.weiguan.jiantong',
});
exports.jiantong.addEffect(sgs.TriggerEffect({
    auto_log: 1,
    auto_directline: 1,
                ...
                return {
                    selectors: {
                        cards: room.createChooseCard({
                            ...
                            filter(item, selected) {
                                const source = cards.find((v) => v.cards.includes(item));
                                if (source.title === 'jiantong.title1') {
                                    return (selected.filter((v) => source.cards.includes(v)).length < 2);
                                }
                                if (source.title === 'jiantong.title2') {
                                    return (selected.filter((v) => source.cards.includes(v)).length < 1);
                                }
                                return false;
                            },
                            canConfirm(selected) {
                                const length1 = selected.filter((v) => cards[0].cards.includes(v)).length;
                                const length2 = selected.filter((v) => cards[1].cards.includes(v)).length;
                                return (length1 > 0 &&
                                    length1 <= 2 &&
                                    length2 > 0 &&
                                    length2 <= 1);
...
exports.weiguan.addSkill(exports.chengxi);
exports.weiguan.addSkill(exports.jiantong);
sgs.loadTranslation({

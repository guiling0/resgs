...
exports.pojing = exports.simazhou = void 0;
exports.simazhou = sgs.General({
    name: 'wars.simazhou',
    kingdom: 'jin',
    hp: 2,
...
exports.pojing = sgs.Skill({
    name: 'wars.simazhou.pojing',
});
exports.pojing.addEffect(sgs.TriggerEffect({
    auto_log: 1,
    auto_directline: 1,
    ...
    async cost(room, data, context) {
        ...
        const options = ['pojing.obtain', 'pojing.call'];
    ...
    async effect(room, data, context) {
        ...
        if (result.includes('pojing.call')) {
            ...
            while (players.length > 0) {
                ...
                const handles = [];
                handles.push(`${openHead.check() && check ? '' : '!'}openHead`);
                handles.push(`${openDeputy.check() && check ? '' : '!'}openDeputy`);
                handles.push(`${openAll.check() && check ? '' : '!'}openAll`);
...
exports.simazhou.addSkill(exports.pojing);
sgs.loadTranslation({

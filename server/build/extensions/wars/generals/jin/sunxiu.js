...
exports.yinsha = exports.xiejian = exports.sunxiu_jin = void 0;
exports.sunxiu_jin = sgs.General({
...
exports.xiejian = sgs.Skill({
    name: 'wars.sunxiu_jin.xiejian',
});
exports.xiejian.addEffect(sgs.TriggerEffect({
    auto_directline: 1,
    auto_log: 1,
...
exports.yinsha = sgs.Skill({
    name: 'wars.sunxiu_jin.yinsha',
});
async function effect(room, target, data) {
    ...
    if (!use && current.target.hasHandCards()) {
        const card = room.createVirtualCard('sha', current.target.getHandCards(), undefined, true);
        card.custom.method = 1;
        if (current.target.canUseCard(card, undefined, this.name, room.createChoosePlayer({
            filter(item, selected) {
...
exports.yinsha.addEffect(sgs.TriggerEffect({
    auto_log: 1,
    ...
    getSelectors(room, context) {
        return {
            skill_cost: () => {
                ...
                const jiedaosharen = room.createVirtualCard('jiedaosharen', handes, undefined, true, false);
                jiedaosharen.custom.method = 1;
                jiedaosharen.custom.canuse = from.canUseCard(jiedaosharen, undefined, effect.name);
                return {
                    selectors: {
...
exports.sunxiu_jin.addSkill(exports.xiejian);
exports.sunxiu_jin.addSkill(exports.yinsha);

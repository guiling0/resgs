...
exports.chengliu = exports.wangjun = void 0;
...
exports.chengliu = sgs.Skill({
    name: 'wars.wangjun.chengliu',
});
exports.chengliu.addEffect(sgs.TriggerEffect({
    auto_log: 1,
                    ...
                    selectors: {
                        player: room.createChoosePlayer({
                            ...
                            filter(item, selected) {
                                return (item.getEquipCards().length <
...
exports.wangjun.addSkill(exports.chengliu);

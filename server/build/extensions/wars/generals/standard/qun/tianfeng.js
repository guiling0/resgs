...
exports.suishi_v2025 = exports.tianfeng_v2025 = exports.suishi = exports.sijian = exports.tianfeng = void 0;
exports.tianfeng = sgs.General({
    name: 'wars.tianfeng',
    kingdom: 'qun',
    hp: 1.5,
...
exports.sijian = sgs.Skill({
    name: 'wars.tianfeng.sijian',
});
exports.sijian.addEffect(sgs.TriggerEffect({
    auto_log: 1,
    auto_directline: 1,
...
exports.suishi = sgs.Skill({
    name: 'wars.tianfeng.suishi',
});
exports.suishi.addEffect(sgs.TriggerEffect({
    tag: [1 /* SkillTag.Lock */],
    auto_log: 1,
...
exports.tianfeng.addSkill(exports.sijian);
exports.tianfeng.addSkill(exports.suishi);
exports.tianfeng_v2025 = sgs.General({
...
exports.suishi_v2025 = sgs.Skill({
    name: 'wars.v2025.tianfeng.suishi',
});
exports.suishi_v2025.addEffect(sgs.TriggerEffect({
    tag: [1 /* SkillTag.Lock */],
    auto_log: 1,
    audio: ['tianfeng/suishi1'],
    trigger: "Death" /* EventTriggers.Death */,
    ...
    async cost(room, data, context) {
        ...
        const handles = ['suishi.losehp', 'suishi.dropcard'];
        if (!losehp.check()) {
            handles[0] = '!' + handles[0];
        }
...
exports.tianfeng_v2025.addSkill(exports.sijian);
exports.tianfeng_v2025.addSkill(exports.suishi_v2025);
sgs.loadTranslation({
    ['suishi.losehp']: '失去体力',

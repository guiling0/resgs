...
exports.ciwei = exports.shenyi = exports.yanghuiyu = void 0;
...
exports.shenyi = sgs.Skill({
    name: 'xl.yanghuiyu.shenyi',
});
exports.shenyi.addEffect(sgs.TriggerEffect({
    auto_log: 1,
    trigger: "onObtainTrigger" /* EventTriggers.onObtainTrigger */,
...
exports.shenyi.addEffect(sgs.TriggerEffect({
    auto_log: 1,
    auto_directline: 1,
    trigger: "BeCost" /* EventTriggers.BeCost */,
    can_trigger(room, player, data) {
        return (this.isOwner(player) &&
...
exports.yanghuiyu.addSkill(exports.shenyi);

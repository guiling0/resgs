...
exports.pingyuan = exports.fengxu = exports.duisong_zongheng = exports.duisong = exports.luyun = void 0;
exports.luyun = sgs.General({
    name: 'xl.luyun',
    kingdom: 'jin',
    hp: 1.5,
...
exports.duisong = sgs.Skill({
    name: 'xl.luyun.duisong',
});
exports.duisong.addEffect(sgs.TriggerEffect({
    auto_directline: 1,
    auto_log: 1,
                    ...
                    selectors: {
                        ...
                        target: room.createChoosePlayer({
                            ...
                            filter(item, selected) {
                                return (item !== from &&
                                    item.hasCanDropCards('he', item, 1, self.name));
                            },
                        }),
                    },
                    options: {
...
exports.duisong_zongheng = sgs.Skill({
    name: 'xl.luyun.duisongzongheng',
});
exports.duisong_zongheng.addEffect(sgs.TriggerEffect({
    auto_directline: 1,
    auto_log: 1,
...
exports.fengxu = sgs.Skill({
    name: 'xl.luyun.fengxu',
});
exports.fengxu.addEffect(sgs.TriggerEffect({
    auto_log: 1,
    auto_directline: 1,
...
exports.pingyuan = sgs.Skill({
    name: 'xl.luyun.pingyuan',
});
exports.pingyuan.addEffect(sgs.TriggerEffect({
    auto_log: 1,
    forced: 'cost',
    ...
    async effect(room, data, context) {
        ...
        if (luji && luji.area && luji.area.type !== 91 /* AreaType.Hand */) {
            const req = await room.doRequest({
                player: from,
                get_selectors: {
                    selectorId: this.getSelectorName('choose'),
            ...
            const skill = room.skills.find((v) => v.name === 'xl.luji_jin.qinghe');
            if (skill) {
...
exports.luyun.addSkill(exports.duisong);
exports.luyun.addSkill(exports.duisong_zongheng, true);
exports.luyun.addSkill(exports.fengxu);
exports.luyun.addSkill(exports.pingyuan);
sgs.loadTranslation({
    ['@duisong']: '对颂：是否获得其一张牌',

...
exports.bagong = exports.yubao = exports.wuxin = exports.zhiheng = exports.lianzi = exports.huibian = exports.rende = exports.jizhao = exports.guitong = exports.taishi = exports.lord_simayan = void 0;
const rules_1 = require("../../rules");
exports.lord_simayan = sgs.General({
...
exports.taishi = sgs.Skill({
    name: 'xl.lord_simayan.taishi',
});
exports.taishi.addEffect(sgs.TriggerEffect({
    ...
    lifecycle: [
        {
            ...
            async on_exec(room, data) {
                const skill = await room.addSkill('xl.lord_simayan.bagongbizhengshu', this.player, {
        ...
        },
        {
            ...
            async on_exec(room, data) {
                await this.getData('bagong').removeSelf();
            },
        },
    ],
}));
        ...
        for (const player of room.playerAlives) {
            ...
            if (index !== -1) {
                ...
                if (general) {
                    ...
                    if (room.getPlayerCountByKingdom(player.kingdom) >
                        room.playerCount / 2) {
                        const kingdom = player.kingdom;
                        let count = room.getPlayerCountByKingdom(player.kingdom) -
...
exports.guitong = sgs.Skill({
    name: 'xl.lord_simayan.guitong',
});
exports.guitong.addEffect(sgs.TriggerEffect({
    tag: [1 /* SkillTag.Lock */],
    priorityType: 0 /* PriorityType.None */,
...
exports.jizhao.addEffect(sgs.TriggerEffect({
    ...
    async effect(room, data, context) {
        ...
        const skill = room.skills.find((v) => v.name === 'xl.lord_simayan.taishi' &&
            ...
            skill_cost: () => {
                ...
                return {
                    ...
                    options: {
                        ...
                        showMainButtons: true,
                        prompt: {
                            text: `${sgs.cac_skill(this.name)}，弃置一张手牌，亮出{0}张牌并获得其中与弃置牌类别相同的牌`,
...
exports.wuxin.addEffect(sgs.TriggerEffect({
    ...
    async cost(room, data, context) {
        const { from } = context;
        const cards = await room.getNCards(room.getPlayerCountByKingdom(from.kingdom, false));
        await room.puto({
            player: from,
            cards,
...
exports.yubao = sgs.Skill({
    name: 'xl.lord_simayan.yubao',
});
exports.yubao.addEffect(sgs.TriggerEffect({
    auto_log: 1,
    priorityType: 1 /* PriorityType.General */,
    trigger: "PlayPhaseProceeding" /* EventTriggers.PlayPhaseProceeding */,
    can_trigger(room, player, data) {
    ...
    async effect(room, data, context) {
        const { from } = context;
        let chibaoshanhu;
        const target = room.playerAlives.find((v) => v.getEquipCards().find((c) => c.name === 'chibaoshanhu'));
        if (target) {
            chibaoshanhu = target
                .getEquipCards()
        ...
        if (!chibaoshanhu) {
            chibaoshanhu = room.discardArea.cards.find((v) => v.name === 'chibaoshanhu');
        }
        if (!chibaoshanhu) {
            chibaoshanhu = room
                .getReserveUpCards()
...
exports.yubao.addEffect(sgs.copy(rules_1.eyes_reserve));
exports.bagong = sgs.Skill({
    name: 'xl.lord_simayan.bagongbizhengshu',
    global(room, to) {
        return room.sameAsKingdom(this.player, to);
    },
});
exports.bagong.addEffect(sgs.TriggerEffect({
    tag: [1 /* SkillTag.Lock */],
    auto_log: 1,
    ...
    getSelectors(room, context) {
        return {
            choose: () => {
                const count = Math.floor(room.getReserveUpCards().length / 2);
                return {
                    selectors: {
                        card: room.createChooseCard({
                            step: 1,
...
exports.lord_simayan.addSkill(exports.taishi);
exports.lord_simayan.addSkill(exports.bagong, true);
exports.lord_simayan.addSkill(exports.guitong);
exports.lord_simayan.addSkill(exports.huibian, true);
exports.lord_simayan.addSkill(exports.jizhao, true);
exports.lord_simayan.addSkill(exports.rende, true);
exports.lord_simayan.addSkill(exports.lianzi, true);
exports.lord_simayan.addSkill(exports.zhiheng, true);
exports.lord_simayan.addSkill(exports.wuxin, true);
exports.lord_simayan.addSkill(exports.yubao);
sgs.loadTranslation({

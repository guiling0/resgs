...
exports.anyong = exports.fenglue_zongheng = exports.fenglue = exports.xunchen = void 0;
exports.xunchen = sgs.General({
    name: 'wars.xunchen',
    kingdom: 'qun',
    hp: 1.5,
...
exports.fenglue = sgs.Skill({
    name: 'wars.xunchen.fenglue',
});
exports.fenglue.addEffect(sgs.TriggerEffect({
    auto_directline: 1,
    auto_log: 1,
    ...
    async effect(room, data, context) {
        ...
        await room.chooseYesOrNo(from, {
            ...
            await room.addSkill('wars.xunchen.fengluezongheng', target, {
                source: this.name,
                showui: 'default',
            });
        });
...
exports.fenglue_zongheng = sgs.Skill({
    name: 'wars.xunchen.fengluezongheng',
});
exports.fenglue_zongheng.addEffect(sgs.TriggerEffect({
    auto_directline: 1,
    auto_log: 1,
...
exports.anyong = sgs.Skill({
    name: 'wars.xunchen.anyong',
});
exports.anyong.addEffect(sgs.TriggerEffect({
    auto_log: 1,
    forced: 'cost',
...
exports.xunchen.addSkill(exports.fenglue);
exports.xunchen.addSkill(exports.anyong);
sgs.loadTranslation({

...
exports.fenming = exports.duanxie = exports.chenwudongxi = void 0;
exports.chenwudongxi = sgs.General({
...
exports.duanxie = sgs.Skill({
    name: 'wars.chenwudongxi.duanxie',
});
exports.duanxie.addEffect(sgs.TriggerEffect({
    auto_log: 1,
    forced: 'cost',
    ...
    can_trigger(room, player, data) {
        if (this.isOwner(player) &&
            ...
            if (this.skill.sourceGeneral === player.head &&
                player.hasDeputy() &&
                !player.deputy.isLord()) {
                return true;
            }
            if (this.skill.sourceGeneral === player.deputy &&
                player.hasHead() &&
                !player.head.isLord()) {
                return true;
            }
...
//     })
// );
exports.fenming = sgs.Skill({
    name: 'wars.chenwudongxi.fenming',
});
exports.fenming.addEffect(sgs.TriggerEffect({
    auto_log: 1,
    auto_directline: 1,
...
//     })
// );
exports.chenwudongxi.addSkill(exports.duanxie);
exports.chenwudongxi.addSkill(exports.fenming);

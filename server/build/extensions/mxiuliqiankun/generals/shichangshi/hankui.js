...
exports.xiaolu = exports.cs_hankui = void 0;
exports.cs_hankui = sgs.General({
    name: 'mobile.cs_hankui',
    kingdom: 'qun',
    hp: 1,
...
exports.xiaolu = sgs.Skill({
    name: 'mobile.cs_hankui.xiaolu',
});
exports.xiaolu.addEffect(sgs.TriggerEffect({
    auto_log: 1,
...
exports.cs_hankui.addSkill(exports.xiaolu);

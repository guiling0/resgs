...
sgs.loadGeneralTranslation('wars.caohong', {
    title: '魏之福将',
    rs: '曹仁',
    death_audio: '曹公，可安好……',
    skills: {
...
sgs.loadGeneralTranslation('wars.dengai', {
    title: '矫然的壮士',
    rs: '',
...
sgs.loadGeneralTranslation('wars.jiangwei', {
    title: '龙的衣钵',
    rs: '诸葛亮·迟暮的丞相',
...
sgs.loadGeneralTranslation('wars.jiangwanfeiyi', {
    title: '社稷股肱',
    rs: '诸葛亮·迟暮的丞相',
...
sgs.loadGeneralTranslation('wars.xusheng', {
    title: '江东的铁壁',
    rs: '丁奉',
...
sgs.loadGeneralTranslation('wars.jiangqin', {
    title: '祁奚之器',
    rs: '周泰',
    death_audio: '竟……破我阵法……',
    skills: {
        ...
        ['wars.jiangqin.niaoxiang']: {
            ...
            desc2: '①阵法技，当【杀】指定目标后，若使用者为你且此目标对应的角色与你相邻且其不是任何队列里的角色，你将此目标对应的角色抵消此【杀】的方式改为依次使用两张【闪】。②阵法技，当【杀】指定目标后，若使用者是你为围攻角色的围攻关系中的一名围攻角色且此目标对应的角色是此围攻关系中的被围攻角色，使用者将此目标对应的角色抵消此【杀】的方式改为依次使用两张【闪】。\n' +
...
sgs.loadGeneralTranslation('wars.hetaihou', {
    title: '弄权之蛇蝎',
...
sgs.loadGeneralTranslation('wars.yuji', {
    title: '魂绕左右',
    rs: '左慈',
...
sgs.loadGeneralTranslation('wars.lidian', {
    title: '深明大义',
    rs: '乐进',
...
sgs.loadGeneralTranslation('wars.zangba', {
    title: '节度青徐',
    rs: '张辽',
...
sgs.loadGeneralTranslation('wars.madai', {
    title: '临危受命',
    rs: '马超',
...
sgs.loadGeneralTranslation('wars.mifuren', {
    title: '乱世沉香',
    rs: '',
...
sgs.loadGeneralTranslation('wars.sunce', {
    title: '江东的小霸王',
    rs: '大乔、周瑜、太史慈',
...
sgs.loadGeneralTranslation('wars.chenwudongxi', {
    title: '壮怀激烈',
...
sgs.loadGeneralTranslation('wars.dongzhuo', {
    title: '魔王',
...
sgs.loadGeneralTranslation('wars.zhangren', {
    title: '索命神射',
    rs: '',
...
sgs.loadGeneralTranslation('wars.bianfuren', {
    title: '奕世之雍容',
    rs: '曹操',
...
sgs.loadGeneralTranslation('wars.xunyou', {
    title: '曹魏的谋主',
    rs: '荀彧',
    ...
    skills: {
        ['wars.xunyou.qice']: {
            ...
            desc2: '当你于出牌阶段内需要使用使用时机为出牌阶段内的空闲时间点且额定目标数下限不大于你的手牌数的普通锦囊牌时❸，若你于此阶段内发动过此技能的次数小于1，你可使用对应的实体牌为你的所有手牌的此普通锦囊牌▶你可变更。\n' +
...
sgs.loadGeneralTranslation('wars.masu', {
    title: '帷幄经谋',
    rs: '',
...
sgs.loadGeneralTranslation('wars.shamoke', {
    title: '五溪蛮王',
    rs: '',
...
sgs.loadGeneralTranslation('wars.lvfan', {
    title: '忠笃亮直',
    rs: '',
...
sgs.loadGeneralTranslation('wars.lingtong', {
    title: '豪情烈胆',
    rs: '甘宁',
...
sgs.loadGeneralTranslation('wars.lijueguosi', {
    title: '犯祚倾祸',
    rs: '贾诩',
...
sgs.loadGeneralTranslation('wars.zuoci', {
    title: '谜之仙人',
    rs: '于吉',
    ...
    skills: {
        ['wars.zuoci.huashen']: {
            ...
            desc2: '①准备阶段开始时，若“化身牌”数：小于2，你可随机观看武将牌堆里的五张牌并将其中的至多两张武将牌扣置于武将牌上（均称为“化身牌”）；大于1，你可将一张“化身牌”置入武将牌堆并随机将武将牌堆里的一张牌扣置于武将牌上（称为“化身牌”）。②你能发动“化身牌”上的未带有技能标签的触发类技能。\n' +
...
sgs.loadGeneralTranslation('wars.yujin', {
    title: '讨暴坚垒',
    rs: '夏侯惇',
...
sgs.loadGeneralTranslation('wars.cuiyanmaojie', {
    title: '日出月盛',
    rs: '曹丕',
    ...
    skills: {
        ...
        ['wars.cuiyanmaojie.fengying']: {
            ...
            desc2: '限定技，当你需要使用【挟天子以令诸侯】时❸，你可使用对应的实体牌为你的所有手牌的【挟天子以令诸侯】▶（→）此【挟天子以令诸侯】指定第一个目标后，所有与你势力相同的角色各将其手牌补至其体力上限。\n' +
...
sgs.loadGeneralTranslation('wars.wangping', {
    title: '键闭剑门',
    rs: '蒋琬费祎',
...
sgs.loadGeneralTranslation('wars.fazheng', {
    title: '蜀汉的辅翼',
    rs: '刘备',
...
sgs.loadGeneralTranslation('wars.wuguotai', {
    title: '慈怀瑾瑜',
    rs: '孙坚',
...
sgs.loadGeneralTranslation('wars.lukang', {
    title: '孤柱扶厦',
    rs: '陆逊',
...
sgs.loadGeneralTranslation('wars.zhangxiu', {
    title: '北地枪王',
    rs: '贾诩',
...
sgs.loadGeneralTranslation('wars.yuanshu', {
    title: '仲家帝',
    rs: '纪灵',
    death_audio: '蜜……蜜水呢……',
    skills: {
...
sgs.loadGeneralTranslation('wars.lord_liubei', {
    title: '龙横蜀汉',
    rs: '蜀势力武将',
...
sgs.loadGeneralTranslation('wars.lord_zhangjiao', {
    title: '时代的先驱',
    rs: '群势力武将',
    death_audio: '天，真要灭我……',
    skills: {
        ...
        ['wars.lord_zhangjiao.huangjinsymbol']: {
            name: '黄巾天兵符',
            desc: '准备阶段开始时，若“黄巾天兵符”上没有牌，你亮出牌堆顶的X张牌并将之置于“黄巾天兵符”上，称为“天兵”。（X为存活的群势力角色数）\n' +
                '与你势力相同的角色可以将一张“天兵”当【杀】使用或打出。\n' +
                '你计算存活的群势力角色数可以至多+X。（X为你的“天兵”的数）\n' +
                '当你失去体力时，若你有“天兵”，你可以终止此次失去体力流程，然后选择一张“天兵”置入弃牌堆。',
            desc2: '①准备阶段开始时，若没有“天兵”，你将牌堆顶的X张牌置于武将牌上，称为“天兵”（X为群势力角色数）。\n' +
...
sgs.loadGeneralTranslation('wars.lord_sunquan', {
    title: '虎踞江东',
    rs: '吴势力武将',
...
sgs.loadGeneralTranslation('wars.lord_caocao', {
    title: '凤舞九霄',
    rs: '魏势力武将',
...
sgs.loadGeneralTranslation('wars.lord_simayi', {
    title: '时代的归墟',
    rs: '晋势力武将',
    ...
    skills: {
        ...
        ['wars.lord_simayi.bahuangsishiling']: {
            ...
            desc2: '①一名晋势力角色的出牌阶段，若其于此轮内明置过武将牌且〖八荒死士令〗于此轮内被发动过的次数小于1且此技能于此局游戏内被发动过的次数小于1，其可移除其副将的武将牌并选择至多三名没有势力的角色▶这些角色各{摸两张牌，可使用【杀】（无距离关系的限制）}。\n' +
...
sgs.loadGeneralTranslation('wars.duyu', {
    title: '文成武德',
    rs: '羊祜',
    ...
    skills: {
        ...
        ['wars.duyu.pozhu']: {
            ...
            desc2: '①主将技，奥秘技，当你选择体力牌时，此武将牌上的单独阴阳鱼个数-1。②主将技，准备阶段开始时，你可使用对应的实体牌为你的一张牌的普【杀】▶若此【杀】的目标数为1，你展示此【杀】的目标对应的角色的一张手牌。若你以此法展示的牌与此【杀】的花色不同，你可重复此流程。\n' +
...
sgs.loadGeneralTranslation('wars.yanghu', {
    title: '执德清劭',
    rs: '杜预',
...
sgs.loadGeneralTranslation('wars.wangxiang', {
    title: '沂川跃鲤',
    ...
    skills: {
        ['wars.wangxiang.bingxin']: {
            ...
            desc2: '当你需要使用本回合未以此法使用过的基本牌时❷，若你的手牌数等于你的体力值且{你的所有手牌颜色均相同或你没有手牌}，你可获得1枚“冰心”▶你展示所有手牌。摸一张牌▷你使用无对应实体牌的此牌。\n' +
...
sgs.loadGeneralTranslation('wars.wenyang', {
    title: '陆拔山岳',
    ...
    skills: {
        ['wars.wenyang.duanqiu']: {
            ...
            desc2: '准备阶段开始时，你可使用无对应的实体牌的【决斗】▶于此【决斗】使用流程结束之后此回合结束之前，若被使用过的{对应的实体牌包含手牌}的牌数不小于X，所有角色不能使用对应的实体牌包含手牌的牌（X为因执行此【决斗】的效果而被打出过的【杀】数）。\n' +
...
sgs.loadGeneralTranslation('wars.zhanghuyuechen', {
    title: '不辱门庭',
    rs: '',
...
sgs.loadGeneralTranslation('wars.baifuren', {
    title: '玲珑心窍',
    rs: '司马懿',
...
sgs.loadGeneralTranslation('wars.yangjun', {
    title: '祸心专辅',
    rs: '',
...
sgs.loadGeneralTranslation('wars.sunxiu_jin', {
    title: '青纸为诏',
    rs: '司马伦',
    ...
    skills: {
        ...
        ['wars.sunxiu_jin.yinsha']: {
            ...
            desc2: '当你需要使用【借刀杀人】时❸，你可使用对应的实体牌为你的所有手牌的【借刀杀人】。\n' +
...
sgs.loadGeneralTranslation('wars.wei.yanghu', {
    title: '制纮同轨',
...
sgs.loadGeneralTranslation('wars.huaxin', {
    title: '渊清玉洁',
    rs: '',
...
sgs.loadGeneralTranslation('wars.zongyu', {
    title: '九酝鸿胪',
    rs: '',
...
sgs.loadGeneralTranslation('wars.dengzhi', {
    title: '绝境的外交家',
    rs: '',
...
sgs.loadGeneralTranslation('wars.fengxi', {
    title: '东吴苏武',
    rs: '',
...
sgs.loadGeneralTranslation('wars.luyusheng', {
    title: '义姑',
    rs: '',
...
sgs.loadGeneralTranslation('wars.miheng', {
    title: '狂傲奇人',
    rs: '孔融',
    death_audio: '恶口……终至杀身……',
    skills: {
...
sgs.loadGeneralTranslation('wars.xunchen', {
    title: '三公谋主',
    rs: '',
...
sgs.loadGeneralTranslation('wars.jiananfeng', {
    title: '凤啸峻峕',
    rs: '',
...
sgs.loadGeneralTranslation('wars.xiahouhui', {
    title: '深渊的白莲',
    rs: '',

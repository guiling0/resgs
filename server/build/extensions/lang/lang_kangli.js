...
sgs.loadGeneralTranslation('xl.caozhi', {
    title: '白马落泞',
    rs: '崔妃 杨修',
...
sgs.loadGeneralTranslation('xl.cuifei', {
    title: '锦雀据棘',
    rs: '曹植',
...
sgs.loadGeneralTranslation('xl.guansuo', {
    title: '拢营簪花',
    rs: '王桃王悦',
...
sgs.loadGeneralTranslation('xl.wangtaowangyue', {
    title: '刀钗并舞',
    rs: '关索',
...
sgs.loadGeneralTranslation('xl.zhuju', {
    title: '舌嚼喉鲠',
    rs: '孙鲁育',
...
sgs.loadGeneralTranslation('xl.sunluyu', {
    title: '二宫堂燕',
    rs: '朱据',
...
sgs.loadGeneralTranslation('xl.zhangze', {
    title: '卧虎',
    rs: '陈慧谦',
...
sgs.loadGeneralTranslation('xl.chenhuiqian', {
    title: '哲鴷',
    rs: '张则',
...
sgs.loadGeneralTranslation('xl.shichong', {
    title: '金谷含悲',
    rs: '绿珠',
...
sgs.loadGeneralTranslation('xl.lvzhu', {
    title: '吹楼将坠',
    rs: '石崇',
...
sgs.loadGeneralTranslation('wars.zhongyan', {
    title: '紫闼飞莺',
    rs: '王浑',
...
sgs.loadGeneralTranslation('wars.wanghun', {
    title: '虚怀绥纳',
    rs: '钟琰',

...
sgs.loadGeneralTranslation('xl.simayan', {
    title: '晋武帝',
    rs: '张华 裴秀',
    death_audio: '汝南王何在……',
...
sgs.loadGeneralTranslation('xl.simazhao', {
    title: '四海威服',
    rs: '王元姬 司马师',
...
sgs.loadGeneralTranslation('xl.wangyuanji', {
    title: '闱芳廷正',
    rs: '司马昭',
...
sgs.loadGeneralTranslation('xl.wenyang', {
    title: '披靡震霄',
    rs: '',
...
sgs.loadGeneralTranslation('xl.simafu', {
    title: '魏之贞士',
    rs: '',
...
sgs.loadGeneralTranslation('xl.simawang', {
    title: '盛銮赞国',
    rs: '',
    death_audio: '',
...
sgs.loadGeneralTranslation('xl.zhanghua', {
    title: '近次夫子',
    rs: '司马炎',
...
sgs.loadGeneralTranslation('xl.peixiu', {
    title: '方寸万里',
    rs: '司马炎',
...
sgs.loadGeneralTranslation('xl.wangjun', {
    title: '起旌览胜',
    rs: '唐彬',
    death_audio: '千帆化作烽烟烬……',
...
sgs.loadGeneralTranslation('xl.hufen', {
    title: '泾传震声',
    rs: '胡烈胡渊',
...
sgs.loadGeneralTranslation('xl.xiahouhui', {
    title: '深潭的青莲',
    rs: '',
    death_audio: '只怨生在帝王家……',
...
sgs.loadGeneralTranslation('xl.wanghun', {
    title: '艨下千里',
    rs: '钟琰',
...
sgs.loadGeneralTranslation('xl.zhongyan', {
    title: '莺咏一族',
    rs: '王浑',
...
sgs.loadGeneralTranslation('xl.tangbin', {
    title: '抚宁疆场',
    rs: '王濬',
...
sgs.loadGeneralTranslation('xl.huliehuyuan', {
    title: '忠魂烈骨',
    rs: '胡奋',
...
sgs.loadGeneralTranslation('xl.lord_simayan', {
    title: '狼图天下',
    rs: '晋势力武将',
    death_audio: '只求，治世能续……',
...
sgs.loadGeneralTranslation('xl.yanghu', {
    title: '闻碑堕泪',
    rs: '杜预',
...
sgs.loadGeneralTranslation('xl.duyu', {
    title: '允文允武',
    rs: '羊祜',
...
sgs.loadGeneralTranslation('xl.weiguan', {
    title: '绵章有折',
    rs: '',
...
sgs.loadGeneralTranslation('xl.zhouzhi', {
    title: '以计代战',
    rs: '',
...
sgs.loadGeneralTranslation('xl.malong', {
    title: '风后再世',
    rs: '',
...
sgs.loadGeneralTranslation('xl.shantao', {
    title: '璞玉浑金',
    rs: '',
...
sgs.loadGeneralTranslation('xl.jishao', {
    title: '中散遗孤',
    rs: '',
...
sgs.loadGeneralTranslation('xl.simashi', {
    title: '晋室的掌旗者',
    rs: '羊徽瑜 司马昭',
...
sgs.loadGeneralTranslation('xl.yanghuiyu', {
    title: '俪皇协运',
    rs: '司马师',
...
sgs.loadGeneralTranslation('xl.wangxiang', {
    title: '履冰执幕',
    rs: '',
...
sgs.loadGeneralTranslation('xl.luji_jin', {
    title: '鸿鹄之裴回',
    rs: '张华 周处',
...
sgs.loadGeneralTranslation('xl.luyun', {
    title: '悬鼓之待槌',
    rs: '张华 周处',

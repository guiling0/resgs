...
2. **实体**：GameCard / VirtualCard / General / Player / Skill / Effect，全部实现 `MarkHost`（任意实体可存键值标记）
...
- `shared/core/entity/`（GameCard/VirtualCard/General/Player/Skill/Effect + MarkHost）
- `shared/core/event/`（EventProcess/EventTypes/EventManager）

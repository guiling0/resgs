...
import { Effect } from '../skill';
import { SkillState, EffectState } from '../schema';
import { TimingName } from '../event';
...
export class SkillManager {
    ...
    addSkill(
        ...
        this.room.state.game.skillStates.set(id.toString(), state);
    ...
    async removeSkill(skill: Skill) {
        ...
        this.room.state.game.skillStates.delete(skill.id.toString());
    }
    ...
    addEffect(
        ...
        this.room.state.game.effectStates.set(id.toString(), state);
    ...
    async removeEffect(effect: Effect, removeSkill: boolean = false) {
        ...
        this.room.state.game.effectStates.delete(effect.id.toString());

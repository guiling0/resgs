...
import { General, GeneralData, GeneralId } from '../general';
import { GeneralState } from '../schema';
import { Player } from '../player';
import { AreaType } from '../card';
...
export class GeneralManager {
    ...
    create(data: GeneralData): General {
        ...
        this.room.state.game.generalStates.set(general.id, state);

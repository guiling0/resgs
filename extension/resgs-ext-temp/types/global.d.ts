...
declare declare function Mode(input: Pick<GameModeData, 'name'> & Partial<GameModeData>): GameModeData;
...
declare class RESGS {
    ...
    readonly ModeBuilder: typeof modeBuilderFactory;
    /** 游戏模式数据构建（name 必传，其余可选，sgs.createMode({ name: 'standard' })） */
    readonly createMode: typeof buildModeData;
    /**

...
export const cs_xiayun = sgs.General({
    name: 'cs_xiayun',
    kingdom: 'qun',
    hp: 1,
    gender: Gender.Male,
...
export const yaozhuo = sgs.Skill({
    name: 'cs_xiayun.yaozhuo',
});
...
export const yaozhuo_delay = sgs.TriggerEffect({
    name: 'yaozhuo.delay',
    mark: ['yaozhuo.delay'],
...
cs_xiayun.addSkill(yaozhuo);

sgs.loadTranslation({
    [yaozhuo_delay.name]: '谣啄',
});
